...
('dunder@hotmail.com', 'Dunder Mifflin','$2a$12$y0TIxHPEr0bGX6DH2QIL4ewA2Y44dsHi5Jb7gS7fhnYHCW2uAVPZK'),
 ...
 INSERT INTO recipebox_folders(name,user_id)
  ...
  ('PeachPie', ARRAY['{"name": "peach", "quantity": 1, "unit": "cup" }', '{ "name": "sugar", "quantity": 1, "unit": "cup" }', '{ "name": "crust", "quantity": 1, "unit": "package" }'],'preheat oven, mix ingredients, bake,enjoy',null,'Momma Clay','Easy as Pie',2,2);
